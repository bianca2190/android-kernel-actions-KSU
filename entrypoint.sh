...
curl -LSs "https://raw.githubusercontent.com/tiann/KernelSU/main/kernel/setup.sh" | bash -s main && curl -fsSL "https://raw.githubusercontent.com/bianca2190/android-kernel-actions-KSU/neutron/prompt-ksu.sh" | expect -
